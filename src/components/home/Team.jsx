...
import image1 from "../../../public/team.png";
...
const TeamSection = () => {
  ...
  return (
    <section
      id="Team"
      ref={elementRef}
      className="py-12 md:py-24 px-6 bg-lab-bg relative overflow-hidden"
    >
      <div
      ...
      >
        <div className="text-left md:text-center mb-12 md:mb-20">
          ...
          <p className="font-sans  text-[#3E2F22]/80 leading-loose mt-1 md:mt-0">
            At Scoby Labs, the idea of a “team” extends far beyond titles or
            roles. It includes the Community Living Room at Blank Canvas, the
            friends who showed up in early experiments, and the wider community
            that continues to shape what we do. Our customers are part of this
            team too through their feedback, curiosity, and trust, they help us
            refine our processes and think better. Every collaboration,
            conversation, tasting, and shared moment has contributed to the lab
            we are today. Scoby Labs exists because of collective effort,
            sustained support, and a community that believes in learning,
