const { Linkedin, MapPin, FlaskConical, Phone, Instagram } = require("lucide-react");
  ...
  return (
    <footer className="py-12 border-t border-[#3E2F22]/10 text-center bg-[#FDFBF7]">
      <div className="flex justify-center space-x-6 mb-8 text-[#3E2F22]/60">
        ...
        <a href="https://www.instagram.com/scobylabs/" className="hover:text-[#BFA15F] transition-colors hover-trigger"><Instagram size={24} /></a>
